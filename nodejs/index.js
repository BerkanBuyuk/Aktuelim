...
app.post("/api", (req, res) => {
  const q =
    "INSERT INTO catalogs (`catalog_id`,`market_id`,`catalog_title`,`catalog_date`,`catalog_added_date`,`catalog_image_url`,`catalog_description`) VALUES (?)";
  const values = [
    req.body.catalog_id,
    req.body.market_id,
    req.body.catalog_title,
    req.body.catalog_date,
    req.body.catalog_added_date,
